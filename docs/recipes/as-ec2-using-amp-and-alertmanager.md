...
``` [Launch Stack](https://prometheus-autoscale.s3.amazonaws.com/prometheus-autoscale.template) ```

(../images/as-ec2-amp-alertmanager4.png)
...
(../images/as-ec2-amp-alertmanager5.png)
